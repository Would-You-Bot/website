  ...
  return new ImageResponse(
    (
      ...
      >
        <div tw="w-full flex flex-col gap-8 mb-auto mt-24">
          <div tw="flex items-center justify-between">
            <div tw="flex items-center bg-gray-800/50 border border-gray-800 px-4 py-2 rounded-lg">
              ...
              />
              <span tw="text-gray-100 text-xl ml-3">{authorData?.globalName ?? "None"}</span>
            </div>
        ...
        <div
          tw="relative flex items-center justify-between w-full"
        >
          {/* Stats Section */}
          <div tw="flex">
            <div tw="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#FFFFFF">
