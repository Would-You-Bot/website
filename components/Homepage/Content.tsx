...
export function HomeContent({
	...
	return (
		...
		>
			...
			</section><section className="mt-20 flex w-full max-w-8xl flex-col items-center gap-20 px-8 text-foreground">
				<motion.div
			...
			</section><section className="mt-36 w-full bg-hover-light px-9 py-12">
				<motion.h2
