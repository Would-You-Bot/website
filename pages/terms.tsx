...
export default function Terms({ member }: Member) {
  return (
    <>
      ...
      <main className="flex flex-col gap-8 px-8 text-neutral-300 xl:px-[17vw]">
        ...
        <div>
          ...
          <p>
            These terms of service (the &quot;Terms&quot;) apply to the Would
            You Discord bot. By using Would You, you agree to be bound by these
            Terms and any additional terms that may be provided by the Company.
            If you do not agree to these Terms, you may not use Would You.
            <br />
          ...
          <p>
            ...
            construed in accordance with the laws of Germany. Any dispute
            arising out of or in connection with these Terms or Would You will
            be resolved through binding arbitration in accordance with the rules
            of the International Chamber of Commerce. You agree that we may take
            action against you if you attack or harm our services. You agree
            that we may use any data collected for the purpose of taking action
            to exclude you from the Service.
          </p>

          <h3 className="my-4 text-lg font-bold text-white">Disclaimer.</h3>
          <p>
            Would You is provided &quot;as is&quot; and &quot;as
            ...
            Discord Bot. It is therefore recommended to use it only with the
