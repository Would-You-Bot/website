...
export default function Privacy({ member }: Member) {
  return (
    <>
      ...
      <main className="flex flex-col gap-8 px-8 text-neutral-300 xl:px-[17vw]">
        ...
        <div>
          ...
          <p>
            ...
            of anonymous aggregate data. We do not use Plausible Analytics to
            track or collect any personally identifiable information about you.
