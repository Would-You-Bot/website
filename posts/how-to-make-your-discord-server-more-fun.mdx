...
pinned: false
toc: ["Fun With Would You", "Minigames", "1. Truth or Dare", "2. Higher or Lower", "3. Never Have I Ever", "4. Would You Rather", "5. What Would You Do?", "Can I Run Events With Would You?", "Conclusion"]
---
...
Similar to Never Have I Ever, but with a twist. What Would You Do provides prompts that invite members to discuss and share their unique approaches to different situations. Like our other minigames, after running the `/whatwouldyoudo` command, members can seamlessly continue the fun directly from the embedded content.
